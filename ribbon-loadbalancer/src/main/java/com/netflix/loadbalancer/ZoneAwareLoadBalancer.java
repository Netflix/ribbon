...
public class ZoneAwareLoadBalancer<T extends Server> extends DynamicServerListLoadBalancer<T> {
    ...
    private static final String ENABLED_PROP_NAME = "ZoneAwareNIWSDiscoveryLoadBalancer.enabled";
    ...
    public ZoneAwareLoadBalancer() {
        ...
        this.enabled = repository.getProperty(ENABLED_PROP_NAME, Boolean.class, true);
    }
    ...
    public ZoneAwareLoadBalancer(IClientConfig clientConfig, IRule rule,
        ...
        this.repository = clientConfig.getDynamicPropertyRepository();
        this.enabled = repository.getProperty(ENABLED_PROP_NAME, Boolean.class, true);
    }
