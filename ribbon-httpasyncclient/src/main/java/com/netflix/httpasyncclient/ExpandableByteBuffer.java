...
/**
 * A data buffer used internally to buffer data that is not consumed by {@link StreamDecoder} so 
 * that it can be used in conjunction with data from the next HTTP chunk. 
 * <p>
