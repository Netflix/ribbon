...
public class PredicatesTest {
    ...
    public void testAvalabilityPredicate() {
        ...
        assertFalse(predicate.apply(new Key((Server) stats[8][0])));
        assertTrue(predicate.apply(new Key((Server) stats[0][0])));
    ...
    public void testZoneAvoidancePredicate() {
        ...
        assertFalse(predicate.apply(new Key((Server) stats[5][0])));
        assertTrue(predicate.apply(new Key((Server) stats[0][0])));
        assertTrue(predicate.apply(new Key((Server) stats[9][0])));
    }
